...
const FormularioProducto = ({
  ...
  return (
    <section className="mainSection px-2 pt-2 pb-5">
      ...
      >
        <p className={`mb-4 fw-bold ${ocultar ? "d-none" : ""}`}>
        ...
        <div className="text-end">
          <Form.Group className="mb-3 ">
            <Button
              type="submit"
              variant="success"
              className={`border border-white border-2 fw-bold px-4 px-sm-5 me-2 ${
                ocultar ? "d-none" : "btnAddProduct"
              }`}
            >
              Agregar
            </Button>
            <Link
              className={`btnCancel btn border border-white border-2 text-white fw-bold px-3 px-sm-5 ${
                verDetalle ? "btn-secondary" : "btnCancel"
              }`}
